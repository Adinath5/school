...
public class HttpHandler {
    ...
    public String makeServiceCall(String jsonURL) {
        return  null;
    }
    ...
    public HttpHandler prepare() throws IOException {
     ...
     * @throws IOException - should be checked by caller
     * */
    public HttpHandler prepare(Method method)throws IOException {
        prepareAll(method);
        return this;
    }
    /**
     ...
     * @return HttpRequest this instance -> for chaining method @see line 22
     * */
    public HttpHandler withHeaders(String... headers){
     ...
     * @throws IOException - should be checked by caller
     * */
    public HttpHandler withData(String query) throws IOException {
     ...
     * @throws IOException - should be checked by caller
     * */
    public HttpHandler withData(HashMap<String, String> params) throws IOException {
