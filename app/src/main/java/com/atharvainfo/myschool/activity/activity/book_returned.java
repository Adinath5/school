...
public class book_returned extends AppCompatActivity {
    EditText txtbookno, txtbookname, txtstudentname;
    Button btnsubmit;
    String Bookno, Bookname, Studentname, Dateofreturned;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        psDialogMsg = new PSDialogMsg(book_returned.this);
        ...
        datechoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(book_returned.this, date, mycal.get(Calendar.YEAR), mycal.get(Calendar.MONTH), mycal.get(Calendar.DAY_OF_MONTH)).show();
    ...
    public void doUpdate() {
        final ProgressDialog progressDialog = new ProgressDialog(book_returned.this);
        ...
        Dateofreturned= datechoice1.getText().toString();
        Log.d("Response", Bookno + " " + Bookname + " " + Studentname+ " " + Dateofreturned);
        ...
        Call<ServerResponse> call = apiInterface.addbookreturned (Bookno,Bookname,Studentname, Dateofreturned);
        call.enqueue(new Callback<ServerResponse>() {
            ...
            public void onResponse(Call<ServerResponse> call, Response<ServerResponse> response) {
                ...
                if (resp.getResult().equals("success")) {
                    ...
                    //goToProfile();
                    psDialogMsg.showInfoDialog("Book Returned...", "Ok");
                    psDialogMsg.show();


                } else {
                    psDialogMsg.showInfoDialog("Book Not Returned.....", "Ok");
                    psDialogMsg.show();
                } }
                @Override
